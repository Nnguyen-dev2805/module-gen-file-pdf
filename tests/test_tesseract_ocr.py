...
class TestTesseractOCR(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_img_path = "temp/test_ocr_canvas.png"
    ...
    def test_detect_text_coordinates_tesseract(self):
        ...
        draw.text((100, 80), "ASRS Storage", fill="#000000")
        img.save(self.test_img_path)

        ocr_results = detect_text_coordinates_tesseract(self.test_img_path)
        ...
        print(f"\nTesseract OCR test results: {ocr_results}")
